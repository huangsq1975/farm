		...
		public struct fcMP4Config
		{
			...
			public static fcMP4Config default_value
			{
				get
				{
					...
					result.video = true;
					result.audio = false;
					result.video_use_hardware_encoder_if_possible = true;
					result.video_width = 320;
					result.video_height = 240;
					result.video_bitrate = 256000;
					result.video_max_framerate = 30;
					result.video_max_buffers = 8;
					result.audio_scale = 32767f;
					result.audio_sampling_rate = 48000;
					result.audio_num_channels = 2;
					result.audio_bitrate = 64000;
					return result;
				}
			}
		}
